...
t = (0:50.000:50000);
EntradaX = [zeros(1,100),ones(1,100),zeros(1,100),ones(1,100)];
...
subplot(5,1,1), plot(t(1:400), EntradaX(1:400));
subplot(5,1,2), plot(t(1:400), SalBajasFrec(1:400));
subplot(5,1,3), plot(t(1:400), SalMediasFrec(1:400));
subplot(5,1,4), plot(t(1:400), SalAltasFrec(1:400));
subplot(5,1,5), plot(t(1:400), SalidaTot(1:400));